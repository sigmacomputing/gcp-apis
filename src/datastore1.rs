...
//! This documentation was generated from *datastore* crate version *1.0.4+20170426*, where *20170426* is the exact revision of the *datastore:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.4*.
//!
...
//!
//! * projects
//!  * [*allocate ids*](struct.ProjectAllocateIdCall.html), [*begin transaction*](struct.ProjectBeginTransactionCall.html), [*commit*](struct.ProjectCommitCall.html), [*lookup*](struct.ProjectLookupCall.html), [*rollback*](struct.ProjectRollbackCall.html) and [*run query*](struct.ProjectRunQueryCall.html)
//!
//!
//!
//!
...
impl<'a, C, A> ProjectRunQueryCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, RunQueryResponse)> {
        ...
        let mut url = "https://datastore.googleapis.com/v1/projects/{projectId}:runQuery"
            .to_string();
    ...
    pub fn add_scope<T>(mut self, scope: T) -> ProjectRunQueryCall<'a, C, A>
        where T: AsRef<str>
    {
...
impl<'a, C, A> ProjectLookupCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, LookupResponse)> {
        ...
        let mut url = "https://datastore.googleapis.com/v1/projects/{projectId}:lookup".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLookupCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectCommitCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, CommitResponse)> {
        ...
        let mut url = "https://datastore.googleapis.com/v1/projects/{projectId}:commit".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectCommitCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectAllocateIdCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, AllocateIdsResponse)> {
        ...
        let mut url = "https://datastore.googleapis.com/v1/projects/{projectId}:allocateIds"
            .to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectAllocateIdCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectRollbackCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, RollbackResponse)> {
        ...
        let mut url = "https://datastore.googleapis.com/v1/projects/{projectId}:rollback"
            .to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectRollbackCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectBeginTransactionCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, BeginTransactionResponse)> {
        ...
        let mut url = "https://datastore.googleapis.com/v1/projects/{projectId}:beginTransaction"
            .to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectBeginTransactionCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
