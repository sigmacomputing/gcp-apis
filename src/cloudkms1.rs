...
//! This documentation was generated from *Cloud KMS* crate version *1.0.4+20170425*, where *20170425* is the exact revision of the *cloudkms:v1* schema built by the [mako](http://www.makotemplates.org/) code generator *v1.0.4*.
//!
...
//! let mut hub = CloudKMS::new(hyper::Client::new(), auth);
...
use common::{MultiPartReader, ToParts, MethodInfo, Result, Error, CallBuilder, Hub, ReadSeek,
             Part, ResponseResult, RequestValue, NestedType, Delegate, DefaultDelegate,
...
impl<'a, C, A> ProjectMethods<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_crypto_key_versions_patch
        (&self,
         ...
         name: &str)
         -> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionPatchCall<'a, C, A> {
    ...
    pub fn locations_key_rings_create(&self,
                                      request: KeyRing,
                                      parent: &str)
                                      -> ProjectLocationKeyRingCreateCall<'a, C, A> {
    ...
    /// * `parent` - Required. The resource name of the location associated with the
    ///              KeyRings, in the format `projects/*/locations/*`.
    pub fn locations_key_rings_list(&self,
                                    parent: &str)
                                    -> ProjectLocationKeyRingListCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_crypto_key_versions_destroy
        (&self,
         ...
         name: &str)
         -> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionDestroyCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_encrypt
        (&self,
         ...
         name: &str)
         -> ProjectLocationKeyRingCryptoKeyEncryptCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_get
        (&self,
         name: &str)
         -> ProjectLocationKeyRingCryptoKeyGetCall<'a, C, A> {
    ...
    pub fn locations_key_rings_test_iam_permissions
        (&self,
         ...
         resource: &str)
         -> ProjectLocationKeyRingTestIamPermissionCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_get_iam_policy
        (&self,
         resource: &str)
         -> ProjectLocationKeyRingCryptoKeyGetIamPolicyCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_update_primary_version
        (&self,
         ...
         name: &str)
         -> ProjectLocationKeyRingCryptoKeyUpdatePrimaryVersionCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_patch
        (&self,
         request: CryptoKey,
         name: &str)
         -> ProjectLocationKeyRingCryptoKeyPatchCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_decrypt
        (&self,
         ...
         name: &str)
         -> ProjectLocationKeyRingCryptoKeyDecryptCall<'a, C, A> {
    ...
    pub fn locations_key_rings_get_iam_policy
        (&self,
         resource: &str)
         -> ProjectLocationKeyRingGetIamPolicyCall<'a, C, A> {
    ...
    pub fn locations_key_rings_set_iam_policy
        (&self,
         ...
         resource: &str)
         -> ProjectLocationKeyRingSetIamPolicyCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_test_iam_permissions
        (&self,
         request: TestIamPermissionsRequest,
         resource: &str)
         -> ProjectLocationKeyRingCryptoKeyTestIamPermissionCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_crypto_key_versions_list
        (&self,
         parent: &str)
         -> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionListCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_list
        (&self,
         parent: &str)
         -> ProjectLocationKeyRingCryptoKeyListCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_crypto_key_versions_create
        (&self,
         request: CryptoKeyVersion,
         parent: &str)
         -> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionCreateCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_crypto_key_versions_get
        (&self,
         name: &str)
         -> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionGetCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_set_iam_policy
        (&self,
         request: SetIamPolicyRequest,
         resource: &str)
         -> ProjectLocationKeyRingCryptoKeySetIamPolicyCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_crypto_key_versions_restore
        (&self,
         ...
         name: &str)
         -> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionRestoreCall<'a, C, A> {
    ...
    pub fn locations_key_rings_crypto_keys_create
        (&self,
         request: CryptoKey,
         parent: &str)
         -> ProjectLocationKeyRingCryptoKeyCreateCall<'a, C, A> {
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionPatchCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    ...
    pub fn doit(mut self) -> Result<(hyper::client::Response, CryptoKeyVersion)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+name}".to_string();
        ...
        let mut json_mime_type = mime::Mime(mime::TopLevel::Application,
                                            mime::SubLevel::Json,
                                            Default::default());
...
impl<'a, C, A> ProjectLocationKeyRingCreateCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, KeyRing)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+parent}/keyRings".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingCreateCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationKeyRingListCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingListCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> CallBuilder
    for ProjectLocationKeyRingCryptoKeyCryptoKeyVersionDestroyCall<'a, C, A> {
}

impl<'a, C, A> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionDestroyCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, CryptoKeyVersion)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+name}:destroy".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// we provide this method for API completeness.
    pub fn request(mut self,
                   new_value: DestroyCryptoKeyVersionRequest)
                   -> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionDestroyCall<'a, C, A> {
        self._request = new_value;
        self
    }
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyEncryptCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, EncryptResponse)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+name}:encrypt".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingCryptoKeyEncryptCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationKeyRingGetCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    ...
    pub fn delegate(mut self,
                    new_value: &'a mut Delegate)
                    -> ProjectLocationKeyRingGetCall<'a, C, A> {
        self._delegate = Some(new_value);
        self
    }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingGetCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyGetCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingCryptoKeyGetCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationListCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListLocationsResponse)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+name}/locations".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationListCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationKeyRingTestIamPermissionCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, TestIamPermissionsResponse)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+resource}:testIamPermissions"
            .to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingTestIamPermissionCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyGetIamPolicyCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, Policy)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+resource}:getIamPolicy".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyUpdatePrimaryVersionCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, CryptoKey)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+name}:updatePrimaryVersion".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// we provide this method for API completeness.
    pub fn request(mut self,
                   new_value: UpdateCryptoKeyPrimaryVersionRequest)
                   -> ProjectLocationKeyRingCryptoKeyUpdatePrimaryVersionCall<'a, C, A> {
        self._request = new_value;
        self
    }
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyPatchCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingCryptoKeyPatchCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyDecryptCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, DecryptResponse)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+name}:decrypt".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingCryptoKeyDecryptCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationKeyRingGetIamPolicyCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingGetIamPolicyCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationKeyRingSetIamPolicyCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, Policy)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+resource}:setIamPolicy".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingSetIamPolicyCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationGetCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationGetCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyTestIamPermissionCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionListCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListCryptoKeyVersionsResponse)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+parent}/cryptoKeyVersions".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyListCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, ListCryptoKeysResponse)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+parent}/cryptoKeys".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingCryptoKeyListCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionCreateCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionGetCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeySetIamPolicyCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
...
impl<'a, C, A> CallBuilder
    for ProjectLocationKeyRingCryptoKeyCryptoKeyVersionRestoreCall<'a, C, A> {
}

impl<'a, C, A> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionRestoreCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    pub fn doit(mut self) -> Result<(hyper::client::Response, CryptoKeyVersion)> {
        ...
        let mut url = "https://cloudkms.googleapis.com/v1/{+name}:restore".to_string();
        if self._scopes.len() == 0 {
            self._scopes
                .insert(Scope::CloudPlatform.as_ref().to_string(), ());
        }
    ...
    /// we provide this method for API completeness.
    pub fn request(mut self,
                   new_value: RestoreCryptoKeyVersionRequest)
                   -> ProjectLocationKeyRingCryptoKeyCryptoKeyVersionRestoreCall<'a, C, A> {
        self._request = new_value;
        self
    }
...
impl<'a, C, A> ProjectLocationKeyRingCryptoKeyCreateCall<'a, C, A>
    where C: BorrowMut<hyper::Client>,
          A: oauth2::GetToken
{
    /// Perform the operation you have build so far.
    ...
    /// encompass more rights than others. For example, for listing resources, a *read-only* scope will be
    /// sufficient, a read-write scope will do as well.
    pub fn add_scope<T>(mut self, scope: T) -> ProjectLocationKeyRingCryptoKeyCreateCall<'a, C, A>
        where T: AsRef<str>
    {
        self._scopes.insert(scope.as_ref().to_string(), ());
        self
